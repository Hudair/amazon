...
class SendAcknowledgement extends Notification implements ShouldQueue
{
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ...
            ->subject(trans('notifications.dispute_acknowledgement.subject', [
                'order_id' => $this->dispute->order->order_number
            ]))
            ->markdown('admin.mail.dispute.acknowledgement', [
    ...
    public function toArray($notifiable)
    {
        return [
            ...
            'message' => trans('notifications.dispute_acknowledgement.message', [
                'order_id' => $this->dispute->order->order_number
            ]),
        ];
    }
