...
class Deposit extends Notification implements ShouldQueue
{
    ...
    public function toMail($notifiable)
    {
        ...
        ->subject(trans('wallet::lang.mail.deposit_subject'))
        ->markdown(
            'wallet::mails.deposit',
            [
    ...
    {
        return [
            'amount' => trans('wallet::lang.mail.deposit_amount', ['amount' => get_formated_currency($this->transaction->amount, 2)]),
        ];
    }
}
